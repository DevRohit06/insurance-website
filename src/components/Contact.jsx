...
export default function Contact() {
  ...
  return (
    <>
      ...
      <section className=" relative z-10 overflow-hidden bg-primary  py-20 lg:py-[120px]">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-base leading-relaxed text-body-color mb-9">
                  At <b className="text-gray-800">LifeInsureEase</b>, we value
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-4 mt-4">
                    <div className="flex items-center gap-4 leading-relaxed">
                      ...
                      <p>
                        Sanghatan chowk buwapada, Ambernath (West),
                        mumbai, Maharashtra
                      </p>
                    </div>
                    <div className="flex items-center gap-4 leading-relaxed">
